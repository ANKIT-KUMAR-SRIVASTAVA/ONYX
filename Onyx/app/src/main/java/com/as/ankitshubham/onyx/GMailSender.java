...
public class GMailSender extends javax.mail.Authenticator {
    ...
    public boolean send() throws Exception {
        ...
        if (!_user.equals("") && !_pass.equals("") && _to.length > 0
            ...
            messageBodyPart.setText(_body[0]);
            _multipart.addBodyPart(messageBodyPart);

            BodyPart messageBodyPart1 = new MimeBodyPart();
            messageBodyPart1.setText(_body[1]);
            _multipart.addBodyPart(messageBodyPart1);

            BodyPart messageBodyPart2 = new MimeBodyPart();
            messageBodyPart2.setText(_body[2]);
            _multipart.addBodyPart(messageBodyPart2);

            BodyPart messageBodyPart3 = new MimeBodyPart();
            messageBodyPart3.setText(_body[3]);
            _multipart.addBodyPart(messageBodyPart3);

            BodyPart messageBodyPart4 = new MimeBodyPart();
            messageBodyPart4.setText(_body[4]);
            _multipart.addBodyPart(messageBodyPart4);
